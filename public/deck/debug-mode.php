<?php
  /**
   * Debug mode page for front end
   *
   * @author      Saneyuki Tadokoro <post@saneyuki.gfunction.com>
   * @copyright   2012, +place
  */
  $beta_prevention = FALSE;
?>
...
<html lang="ja">
  ...
  <head>
    ...
    <?php
      $stylesheet_url = $beta_prevention !== TRUE ? 'style/template-beta.css' : 'style/template.css';
  ...
  <body>
    ...
    <script type="text/javascript">
      lias.debugMode = true;
      <?php
        if( $beta_prevention !== TRUE )
          print( 'require.config({ paths:{ "lancher": "scripts/view/lancher-beta" } }); ');
      ?>
    </script>
  </body>
